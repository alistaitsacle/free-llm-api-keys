...
> ⏰ Last updated: 2026-04-30 19:39 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-vKmDrQ4T7ZQendIZnnjX5aqQDGvhB9cu8BR3iVUdzfR5setf` | gpt-5.5 | 🆕 New | $49 | 5 RPM | 2026-05-02 | Premium GPT flagship |

---

### Claude Opus 4.7 `04-30 19:39`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (claude-opus-4-7 fallback) | 🛟 Fallback | $49 | 10 RPM | 2026-05-02 | Claude Opus flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
| `sk-oAoc48XwNt2XpaixEDmjgBNFnUWXdnIBkzM4s6waeO5wGwO2` | deepseek-chat | 🆕 New | $12 | 20 RPM | 2026-05-02 | Everyday chat, coding, translation, writing |

---

### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `04-30 19:39`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat | 🆕 New | $49 | 10 RPM | 2026-05-02 | Auto-routes across currently healthy low-cost chat backends |
| `sk-iHHGWK28kUJOtwOoRt2JABAg2EFMpAi08jPMeIQwAbgPbmYq` | smart-chat | 🆕 New | $23 | 10 RPM | 2026-05-01 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (kimi-k2.5 fallback) | 🛟 Fallback | $49 | 10 RPM | 2026-05-02 | Kimi long-context general model — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Image / Audio / Embedding `04-30 19:39`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (dall-e-3 / tts / embeddings fallback) | 🛟 Fallback | $49 | 10 RPM | 2026-05-02 | Image, audio, and embedding models — auto-routes via smart-chat while restocking | <!-- fallback -->
