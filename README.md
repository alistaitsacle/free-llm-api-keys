...
> ⏰ Last updated: 2026-04-29 12:01 (UTC+8)
>
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-kkNPf3gVEECJGNFsPw43JZB72KYJZVCPawbcZ1AJeWhZ2cVf` | smart-chat | 🆕 New | $50 | 10 RPM | 2026-05-01 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-OM2owIPZtr7wswM1CMeNSEr1i9EUXIA549hmQf4qL9oEHTEF` | gpt-5.4 | 🆕 New | $50 | 5 RPM | 2026-05-01 | Premium GPT flagship for quality-sensitive chat and coding |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-5RqEYfhkciFDP1Bvk2i7AnMsPDLVfWnYCg3L2UHTycEiuHxG` | claude-sonnet-4-6 | 🆕 New | $50 | 5 RPM | 2026-05-01 | Premium Claude Sonnet for writing, code review, and long answers |
