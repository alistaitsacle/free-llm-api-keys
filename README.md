...
> ⏰ Last updated: 2026-05-01 17:52 (UTC+8)
>
...
### DeepSeek `05-01 17:52`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-6tG7WvLHFsLknXbw508rBqE03e38DS17bGBEoaP7O8BZlrFr` | deepseek-chat | 🆕 New | $10 | 20 RPM | 2026-05-03 | Everyday chat, coding, translation, writing |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 17:52`
...
### Image / Audio / Embedding `05-01 17:52`
