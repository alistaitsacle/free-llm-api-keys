...
> ⏰ Last updated: 2026-05-05 17:31 (UTC+8)
>
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-05 17:31`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-j7VDJPBm2eFEohiCBFWAQBztP2Nafo3dAiYqWrOf6JYXAZRt` | smart-chat | 🆕 New | $12 | 10 RPM | 2026-05-07 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-05 17:31`
