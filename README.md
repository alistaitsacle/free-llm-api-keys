...
> ⏰ Last updated: 2026-04-30 20:22 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-vKmDrQ4T7ZQendIZnnjX5aqQDGvhB9cu8BR3iVUdzfR5setf` | gpt-5.5 | 🆕 New | $32 | 5 RPM | 2026-05-02 | Premium GPT flagship |

---

### Claude Opus 4.7 `04-30 20:22`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (claude-opus-4-7 fallback) | 🛟 Fallback | $39 | 10 RPM | 2026-05-02 | Claude Opus flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `04-30 20:22`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat | 🆕 New | $39 | 10 RPM | 2026-05-02 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (kimi-k2.5 fallback) | 🛟 Fallback | $39 | 10 RPM | 2026-05-02 | Kimi long-context general model — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Image / Audio / Embedding `04-30 20:22`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (dall-e-3 / tts / embeddings fallback) | 🛟 Fallback | $39 | 10 RPM | 2026-05-02 | Image, audio, and embedding models — auto-routes via smart-chat while restocking | <!-- fallback -->
