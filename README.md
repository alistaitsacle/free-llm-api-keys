...
> ⏰ Last updated: 2026-05-05 21:07 (UTC+8)
>
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-05 21:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-HBarXBScSvDepNgcKHFasGC14FTrJEWIcwB9rFY7PoFobpk1` | smart-chat | 🆕 New | $9 | 10 RPM | 2026-05-07 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-05 21:07`
