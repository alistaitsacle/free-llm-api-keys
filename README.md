...
> ⏰ Last updated: 2026-05-07 11:07 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-p2tVLaheXhuB3D2jucpbXQFznp9FMRBJcADUYm8ennslHIkM` | gpt-5.5 | 🆕 New | $16 | 5 RPM | 2026-05-08 | Premium GPT flagship |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-07 11:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-RfwtbJ1G56vaJMj3WvKZ30zpM9lo6jYSd2tg8pvmQfXqOp3D` | smart-chat | 🆕 New | $11 | 10 RPM | 2026-05-08 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-07 11:07`
