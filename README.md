...
> ⏰ Last updated: 2026-05-04 21:52 (UTC+8)
>
...
### DeepSeek `05-04 21:52`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-GrbAHGpoCa1RWGs0LcKkzJPMgSUhRyCC6hVrSqKAmKoJQasr` | deepseek-chat | 🆕 New | $18 | 20 RPM | 2026-05-06 | Everyday chat, coding, translation, writing |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-04 21:52`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-GKKKI3Dd9jtkbPS7ljAAhDQOcNNuUmGVsEE0yrVef65yZPmC` | smart-chat | 🆕 New | $10 | 10 RPM | 2026-05-06 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-04 21:52`
