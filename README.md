...
> ⏰ Last updated: 2026-04-29 18:07 (UTC+8)
>
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-MGLG7atn0H3Ksxde7hE9If8oGpst9alqmXsKq4HDODawcNXX` | gpt-5.4 | 🆕 New | $50 | 5 RPM | 2026-05-01 | Premium GPT flagship for quality-sensitive chat and coding |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-ZYKZOU2swsnW8eNDZf6idMGxfUd67672oZrPRcLirxXWgQCW` | claude-sonnet-4-6 | 🆕 New | $50 | 5 RPM | 2026-05-01 | Premium Claude Sonnet for writing, code review, and long answers |
