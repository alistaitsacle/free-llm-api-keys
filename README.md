...
> ⏰ Last updated: 2026-05-02 10:07 (UTC+8)
>
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (claude-opus-4-7 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-04 | Claude Opus flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-02 10:07`
...
### Image / Audio / Embedding `05-02 10:07`
