...
> ⏰ Last updated: 2026-05-01 10:07 (UTC+8)
>
...
### Claude Opus 4.7 `05-01 10:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-35mV2xARxravSL7Dmd0w5EFZ9vEfGba3WkK30Wg0c8gW3hII` | smart-chat (claude-opus-4-7 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Claude Opus flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 10:07`
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-35mV2xARxravSL7Dmd0w5EFZ9vEfGba3WkK30Wg0c8gW3hII` | smart-chat (kimi-k2.5 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Kimi long-context general model — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Image / Audio / Embedding `05-01 10:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-35mV2xARxravSL7Dmd0w5EFZ9vEfGba3WkK30Wg0c8gW3hII` | smart-chat (dall-e-3 / tts / embeddings fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Image, audio, and embedding models — auto-routes via smart-chat while restocking | <!-- fallback -->
