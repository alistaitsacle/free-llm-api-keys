...
> ⏰ Last updated: 2026-05-01 21:37 (UTC+8)
>
...
### DeepSeek `05-01 21:37`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-mpVTPyPqfbTJUniIrWhXF7qvSwSBqmQrCAQKqWBo4gmkVKvc` | deepseek-chat | 🆕 New | $12 | 20 RPM | 2026-05-02 | Everyday chat, coding, translation, writing |

---

### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 21:37`
...
### Image / Audio / Embedding `05-01 21:37`
