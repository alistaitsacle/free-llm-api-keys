...
> ⏰ Last updated: 2026-05-01 21:30 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-lCQWtTMdIbCoD2X00NOWk1LPgAk9QYRbUOZfju89zF64p9YP` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
| `sk-0mqojOWKoRxLPeFx33coPPEBF2ZgD2vq4h36ZFJgTyf0vSjg` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
| `sk-D4K7XlAvr2onGgj8Di4tx76ulXCnfe6gXSTzMKwGuqstsszo` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
| `sk-sLHYUKAeBO7TfP4cD06OuHwsKyQ2pui0zf0avP0lBtEIRNqI` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
| `sk-j8qRrqXpElHTbhmJGS6DD9K7MIcYfPyiFJAqXwbkK8QzbNts` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
| `sk-cfvLrjCox2DH7k4TWi0NTAFNmQIALvI0GZAKqMQ47JLwdA2E` | gpt-5.5 | 🆕 New | $20 | 5 RPM | 2026-05-03 | Premium GPT flagship |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-ehWceeGWEBVR4C2x6OXwWpBiRQiTWQEStJZS0QwbwI8WTfP7` | smart-chat (claude-opus-4-7 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Claude Opus flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-B5r2hLqffjKNllTLvuxdNDrj1dX53rM51Sq70oDodOiBE4Jz` | deepseek-chat | 🆕 New | $20 | 20 RPM | 2026-05-03 | Everyday chat, coding, translation, writing |
| `sk-UDC6i6ng6YWhaezj2fuK7vLIma7WvKq7cwFBQMsbBbuvYZIC` | deepseek-chat | 🆕 New | $20 | 20 RPM | 2026-05-03 | Everyday chat, coding, translation, writing |
| `sk-KtVrJcqwqpeZjvOHq42P0v4Kdtg0F2NYc5SzBflxWS79C5jT` | deepseek-chat | 🆕 New | $20 | 20 RPM | 2026-05-03 | Everyday chat, coding, translation, writing |
| `sk-Q6gaOjlrcwmmsttZdLDO3cofKmgk7lregVRpvDDOS08dpf3Z` | deepseek-chat | 🆕 New | $14 | 20 RPM | 2026-05-02 | Everyday chat, coding, translation, writing |
| `sk-1RkX3ihMnBG3DRqrITJtW741jhgB647ZxAexr3IaLuFLpDVD` | deepseek-chat | 🆕 New | $13 | 20 RPM | 2026-05-02 | Everyday chat, coding, translation, writing |

---

### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 21:30`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-ehWceeGWEBVR4C2x6OXwWpBiRQiTWQEStJZS0QwbwI8WTfP7` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
| `sk-FQJkFsX6bsY17BC61Y8WwReTlvInWvTXcx64XfPZM76HKqBY` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
| `sk-nQRdUFIXndTCTDC844FAyuqzOcS7a1stHdYN2bBKHHWe2x9s` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
| `sk-qcKBRTCkm4F0l2FQ5VrCe14Qv0izfv6maQaZ4yOy92qvRCgl` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Yt0chvBWskBeF4VDYuGqWljPEHbkgpjIf3KBeF7ZtDMRjhXK` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
| `sk-dCcYuGyhYqpAjB2ezdVIym1I3Rqa7YHiq99uw4gkWE2pt75p` | smart-chat | 🆕 New | $20 | 10 RPM | 2026-05-03 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-ehWceeGWEBVR4C2x6OXwWpBiRQiTWQEStJZS0QwbwI8WTfP7` | smart-chat (kimi-k2.5 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Kimi long-context general model — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Image / Audio / Embedding `05-01 21:30`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-ehWceeGWEBVR4C2x6OXwWpBiRQiTWQEStJZS0QwbwI8WTfP7` | smart-chat (dall-e-3 / tts / embeddings fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Image, audio, and embedding models — auto-routes via smart-chat while restocking | <!-- fallback -->
