...
> ⏰ Last updated: 2026-05-03 15:07 (UTC+8)
>
...
### DeepSeek `05-03 15:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-suxUZb4AaWvsCJmG5rpQkGMVOFhRpfapQkuZmeGaDGkFfj7h` | deepseek-chat | 🆕 New | $9 | 20 RPM | 2026-05-04 | Everyday chat, coding, translation, writing |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-03 15:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-rC48SsCX7BCBG7VjXGdh1dwBSASn5inaE0VOdGBzrQomGWKU` | smart-chat | 🆕 New | $8 | 10 RPM | 2026-05-05 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-03 15:07`
