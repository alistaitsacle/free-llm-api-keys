...
> ⏰ Last updated: 2026-05-02 10:52 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (gpt-5.5 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-04 | Premium GPT flagship — auto-routes via smart-chat while restocking | <!-- fallback -->
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-02 10:52`
...
### Image / Audio / Embedding `05-02 10:52`
