...
> ⏰ Last updated: 2026-05-01 11:22 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat (gpt-5.5 fallback) | 🛟 Fallback | $20 | 10 RPM | 2026-05-03 | Premium GPT flagship — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Claude Opus 4.7 `05-01 11:22`
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 11:22`
...
### Image / Audio / Embedding `05-01 11:22`
