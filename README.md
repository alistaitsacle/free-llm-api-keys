...
> ⏰ Last updated: 2026-05-01 15:07 (UTC+8)
>
...
### DeepSeek `05-01 15:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-NwPxtPgAG3d4uEH3j14QaT7Fv440NSv4DQPhhzZK5CLSH1qm` | deepseek-chat | 🆕 New | $12 | 20 RPM | 2026-05-02 | Everyday chat, coding, translation, writing |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-01 15:07`
...
### Image / Audio / Embedding `05-01 15:07`
