...
> ⏰ Last updated: 2026-05-05 10:37 (UTC+8)
>
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-05 10:37`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-GYdS8ZNnFa9cyIgWf24NvJixbgIX81SFKArsaHQsGy4DKjwm` | smart-chat | 🆕 New | $9 | 10 RPM | 2026-05-06 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-05 10:37`
