...
> ⏰ Last updated: 2026-04-30 20:07 (UTC+8)
>
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `04-30 20:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-lSxEPLPnaYaWq3rjm8CmPF6pmHIyXDr6jiNFcvGjiRMrr1YQ` | smart-chat | 🆕 New | $18 | 10 RPM | 2026-05-02 | Auto-routes across currently healthy low-cost chat backends |
...
| `sk-lzyHv6f30cnPxf2vEsBsTud7YkGzuOTI1965bi9KJqeKsoNw` | smart-chat | 🆕 New | $18 | 10 RPM | 2026-05-02 | Auto-routes across currently healthy low-cost chat backends |
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat | 🆕 New | $19 | 10 RPM | 2026-05-02 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-lSxEPLPnaYaWq3rjm8CmPF6pmHIyXDr6jiNFcvGjiRMrr1YQ` | smart-chat (kimi-k2.5 fallback) | 🛟 Fallback | $18 | 10 RPM | 2026-05-02 | Kimi long-context general model — auto-routes via smart-chat while restocking | <!-- fallback -->

---

### Image / Audio / Embedding `04-30 20:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-lSxEPLPnaYaWq3rjm8CmPF6pmHIyXDr6jiNFcvGjiRMrr1YQ` | smart-chat (dall-e-3 / tts / embeddings fallback) | 🛟 Fallback | $18 | 10 RPM | 2026-05-02 | Image, audio, and embedding models — auto-routes via smart-chat while restocking | <!-- fallback -->
