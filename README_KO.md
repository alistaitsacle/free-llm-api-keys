...
> ⏰ 마지막 업데이트: 2026-06-29 19:22 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-29 19:22`
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-ZDcLj8uxRxLTuASbYcr1U2w7m9WVBKqAn1n7b4swC9ibrHTs` | kimi-k2.5 | 🆕 신규 | $0 | 10 RPM | 2026-07-01 | Kimi long-context general model |
| `sk-C9gJ1BwutT8RGmWhpwM174XoRYbCVcCjLWWUmxsC2oibrRxz` | kimi-k2.5 | 🆕 신규 | $12 | 10 RPM | 2026-07-01 | Kimi long-context general model |
