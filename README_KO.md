...
> ⏰ 마지막 업데이트: 2026-06-29 14:37 (UTC+8)

### 주요 모델

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-29 14:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-YmxOOOiccUXRF2iLOhW49m5UFNqlho1rZhM8ux9kSmq7Wp6f` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-bjGKU9coQpNhyOS5dulWGkoxZm56kCHNDtlAVBzA4V1LL16j` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-ewxywnq9wzKjACfDKwerEWM0TU8ZgiWamr1Lqc7OCJ1xOeJI` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-68GjVDsW9Rl03FRNPY2tfvgPp97KfO0HQTB6RIoP490tlLWa` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-CcsRY3MKpHmumkcjo8F9h214JfjOSprsB6VM0nKcBCkNuy8W` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-OtQEPQeCHK9ckaYjQKY1hZsj1aFuXegZOdd0dMH1Bh1RjKW8` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-07-01 | Auto-routes across currently healthy low-cost chat backends |
