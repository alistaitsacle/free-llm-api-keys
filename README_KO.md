...
> ⏰ 마지막 업데이트: 2026-06-24 03:37 (UTC+8)
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-WiyX4lkDLxtNeelOTBAxFtkPfZiRyJd6lDVoOlbikx6esye4` | deepseek-chat | 🆕 신규 | $16 | 20 RPM | 2026-06-25 | Everyday chat, coding, translation, writing |

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 03:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-gan1bCmRIkYWDk4Z6wYqUriL7Uj3QsunsBXvbpyVeo1EJntz` | smart-chat | 🆕 신규 | $14 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |
