...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-jePOwTbZ8Rq3MyjuDLYGDJ4ju5UncGsiQeeZvDL3gP80bT2A` | deepseek-chat | 🆕 新規 | $14 | 20 RPM | 2026-05-26 | Everyday chat, coding, translation, writing |
