...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-22 11:22`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-KeaxhSBwCkutmklkL0B0DVYLzTN9IGtRp1j8IScPi3GDHJgr` | smart-chat | 🆕 新規 | $19 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-22 11:22`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-SkLozpyhkvg7bSshTP4FuiqXQt3lGvJEatoVXJr2Kb1dQMUz` | kimi-k2.5 | 🆕 新規 | $10 | 10 RPM | 2026-06-23 | Kimi long-context general model |
