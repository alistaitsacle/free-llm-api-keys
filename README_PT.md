...
> ⏰ Última atualização: 2026-06-12 22:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-12 22:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-MBpskefCew6gRpF7ztiSX1dx46T8wDvU5wQXgaTHEe0zFRzD` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-339UlZ02J5JcmEt1dtjHshL3Co1wTborBZImnO6wf0r5kmgG` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
...
| `sk-O0KbT6ipZlOlaqH8IDZrHmozVzehLGzE9YVNMSw0BHwQsiuT` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-12 22:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-iuecCauTql8SQx3shDw5F9LyZjOUX5TCnFVhE7GJD04lXJK7` | kimi-k2.5 | 🆕 Nova | $4 | 10 RPM | 2026-06-14 | Kimi long-context general model |
