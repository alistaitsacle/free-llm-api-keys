...
> ⏰ Última atualização: 2026-06-19 20:52 (UTC+8)

### Modelos em destaque

### Claude Opus 4.7 `06-19 20:52`
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-19 20:52`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Y3oo8PldWZJTEDMfFnyt00nFeHeos6gGPDHUTbIm2QxBP8cM` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-21 | Kimi long-context general model |
...
### Image / Audio / Embedding `06-19 20:52`
