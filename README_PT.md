...
> ⏰ Última atualização: 2026-06-14 04:52 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-14 04:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-K1SfF6dIkwcdQZkaJzcRJP2SFqNlUkECDVhrPdqd4E7DZa1N` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-EBQ2pvZtWPoWwWo1jq0rv8FKO3HFcDrFy6dSfFTGeC4SLZZx` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-UrohFDUAoIH2bbZvVEPqscGvE5aTZa2A1qvchmOtZPJ3FZVk` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-BJJTiBlDymwcBBCC8HbP1DhaBe88Xe3Tgp1FsnRjt4PELIgu` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-EjjdQMFuYEJn1svTt3chlBCDcwT4lGNweQ49i8xuiYHEjDtK` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-gUetl89yqX6OfAB3xjyihXrzdCN2pG5gTwItPAlTNXLJBMQH` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-14 04:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-r5yCbHyy27GQCgJpaCHP0C9FvWzsH7K2ZLzI7PI3ewe7W3nw` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-15 | Kimi long-context general model |
| `sk-kxkopLw9uoDiCLNVYNq8xfVAnwQCTRm3OGhj8wZXeEl7144k` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-15 | Kimi long-context general model |
| `sk-BvD4CNETlXRutVRK38fTRRKbpjPaMEdPe6J45tiTpw9nr38I` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-15 | Kimi long-context general model |
| `sk-2MUuX3pkXT83RkKm6yDH0Fh622tTeMi9DVvRfm4qeWU6vNPE` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-15 | Kimi long-context general model |
