...
> ⏰ Última atualização: 2026-05-25 16:37 (UTC+8)
...
### DeepSeek `05-25 16:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-dQfOBL4SpMDm6csGubxYyiMEWhTEtMsglgvvVrMCz3fINzTS` | deepseek-chat | 🆕 Nova | $11 | 20 RPM | 2026-05-27 | Everyday chat, coding, translation, writing |

### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `05-25 16:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-lgN9h0iTZryZoFB7MNZXgbYAMC9KV5nKTVhQhSKcpl5KkfP1` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-05-27 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-25 16:37`
