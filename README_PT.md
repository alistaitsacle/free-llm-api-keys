...
> ⏰ Última atualização: 2026-06-26 13:22 (UTC+8)

### Modelos em destaque

### Claude Opus 4.7 `06-26 13:22`
...
### DeepSeek `06-26 13:22`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-ACwBh7robPk5NWQrLNPOAq33rumaojj3Od1KBgku9nEnrgVC` | deepseek-chat | 🆕 Nova | $12 | 20 RPM | 2026-06-27 | Everyday chat, coding, translation, writing |

### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-26 13:22`
...
### Image / Audio / Embedding `06-26 13:22`
