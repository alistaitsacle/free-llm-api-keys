...
> ⏰ Última atualização: 2026-06-08 01:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-08 01:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-SmMioiHpG56gWI1aZoQV0WVitUl5AiSzxc1hyVFfPGWxkYeL` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-m4bKoOsHC7z7XY8tHjr3wUbxR7BuGEqowNFxZbgqEE7XOBF1` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-08 01:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-9k39V9Eprpj0t6dNqwUHE2LvM0Mbllr12ClFgnckldGGrNrt` | kimi-k2.5 | 🆕 Nova | $14 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-3kB7S2ZlrfQuzK9TuwHvZy1aGFQJMpLm88VaKPwLFbdDDlSf` | kimi-k2.5 | 🆕 Nova | $15 | 10 RPM | 2026-06-09 | Kimi long-context general model |
