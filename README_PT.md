...
> ⏰ Última atualização: 2026-06-18 21:07 (UTC+8)

### Modelos em destaque

### Claude Opus 4.7 `06-18 21:07`
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-18 21:07`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-ElQMtSGYN2jj3V1Y3nuiGL92iCLZokyQVxdrDCH5WLSsZX61` | kimi-k2.5 | 🆕 Nova | $14 | 10 RPM | 2026-06-20 | Kimi long-context general model |

### Image / Audio / Embedding `06-18 21:07`
