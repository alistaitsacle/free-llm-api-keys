...
> ⏰ Última atualização: 2026-06-22 11:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-22 11:22`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-KeaxhSBwCkutmklkL0B0DVYLzTN9IGtRp1j8IScPi3GDHJgr` | smart-chat | 🆕 Nova | $19 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `06-22 11:22`
