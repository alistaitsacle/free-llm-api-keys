...
> ⏰ Última actualización: 2026-06-25 07:22 (UTC+8)

### Modelos destacados

### Claude Opus 4.7 `06-25 07:22`
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-Ukyatly03S6iwgSYNupqqtI1QtdrEGvy90D7pFUbAHrVUgi8` | kimi-k2.5 | 🆕 Nueva | $4 | 10 RPM | 2026-06-26 | Kimi long-context general model |
| `sk-QoIQexXqQiX1NtiPrNeaGJ3AOCbcRWlJaHTMAvaqBNPjTgBg` | kimi-k2.5 | 🆕 Nueva | $10 | 10 RPM | 2026-06-26 | Kimi long-context general model |
...
### Image / Audio / Embedding `06-25 07:22`
