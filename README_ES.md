...
> ⏰ Última actualización: 2026-06-17 20:22 (UTC+8)

### Modelos destacados

### Claude Opus 4.7 `06-17 20:22`
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-EQzoUXISOz0bplXTy5DtIEh805pr0TfUVtd79gZnR2MChRry` | kimi-k2.5 | 🆕 Nueva | $10 | 10 RPM | 2026-06-19 | Kimi long-context general model |

### Image / Audio / Embedding `06-17 20:22`
