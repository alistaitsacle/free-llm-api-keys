...
> ⏰ Última actualización: 2026-06-19 12:30 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-LuBls4zz3mPWCRYXwWJgq4oruwuzgHrUPvL7W78DribOgXeP` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-nkYD8biGBouOPNmhVmraOjIZnXnmu7wDsfEGVEoUUCiar83B` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-7Chdhk5Ux25jceqnzA3GIuT7sMNqzWaWUUDNLqqPRSxG3EM0` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-IXT58BuDZZKy4TVyOExKKFz7apg5AyiRS60rwaLNZt1zn7t3` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-0lsLAWGYdeLQaxITixP2lOM1YZ8625PZw3KyvNSzLx76kOiL` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-jlthvCwEYM52bhjnsY7JzBFBt6yvMn8QNOX3Z6suxHo1YnUn` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-19 12:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-zbYTpRH8t31eHYhDMgl9nhhcYj12ABoP5v0R6nV1myLTyMY4` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-qSsnA5RNRhz0fMMzubRi09eqPKshjlnZ9JWHv0TKSat3t0eK` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-cxmVbzkQo3OrVJnEytHhaTIhn024MJncgHCYetvTJBHYkP2R` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-GVWo1EDVaf7p2KXRqoBE9T1ZEVmhZqq3PAd2FGjUrtLTacM4` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-f8TgevYPaO6lpnSoioDW8xjaBuk85KIormXbRu9H8fRinUMm` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-i5vjmCcSYWCnpNcIZLK9PY2WOPDUhV4n9EJdXMqsp817OnSo` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-19 12:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-mOuMiOqpzloCfZSI4td3IkXjaAykNCWfJZPZL5qhnZgU6ONG` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-Alj2kv5W7YxTTwMMmwR4nRDYqTuMPJwGW7myX5glwbxfzHga` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-qV4wT73VmxN7n5YmTp0nCwnjJtX8oKujOyQQBCim2u5l3995` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
