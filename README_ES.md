...
> ⏰ Última actualización: 2026-06-03 02:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-03 02:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-592qGzkNO2oYDlkxGWkzYjDbsXBQo1b94FrAVP5zPSlVFUbU` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-04 | Auto-routes across currently healthy low-cost chat backends |
