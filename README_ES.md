...
> ⏰ Última actualización: 2026-07-01 08:37 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-qjUcD2LRUKKHcUPj3RaFhQ4VW0VVRjbjG2RndVwJAO9upskO` | claude-opus-4-7 | 🆕 Nueva | $15 | 5 RPM | 2026-07-02 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `07-01 08:37`
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-kkLDrAUbWCglhcv8oBsnZa74XmygBaePVMZZQ1R3QBcIzIS9` | kimi-k2.5 | 🆕 Nueva | $17 | 10 RPM | 2026-07-02 | Kimi long-context general model |
