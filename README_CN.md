...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 17:07`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-j7VDJPBm2eFEohiCBFWAQBztP2Nafo3dAiYqWrOf6JYXAZRt` | smart-chat | 🆕 新增 | $13 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-ylkQrzdUFgvnnDaBABYM56oTfTeGGp3N8L9YARWzUiCMNjTO` | smart-chat | 🆕 新增 | $14 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lxGDaMRtncKskYnOUDaLU9Hg2HqeSDUofrig2FJfQnwtkMPU` | smart-chat | 🆕 新增 | $13 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-HBarXBScSvDepNgcKHFasGC14FTrJEWIcwB9rFY7PoFobpk1` | smart-chat | 🆕 新增 | $15 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-CwPzdQThZQ0X2JPqxCZlETg0b09PcXcI9RPtwRwcZZw4gxVy` | smart-chat | 🆕 新增 | $16 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
