...
|-----|------|------|------|---------|---------|------|
| `sk-vKmDrQ4T7ZQendIZnnjX5aqQDGvhB9cu8BR3iVUdzfR5setf` | gpt-5.5 | 🆕 新增 | $49 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $49 | 10 RPM | 2026-05-02 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `04-30 19:39`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat | 🆕 新增 | $49 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-iHHGWK28kUJOtwOoRt2JABAg2EFMpAi08jPMeIQwAbgPbmYq` | smart-chat | 🆕 新增 | $23 | 10 RPM | 2026-05-01 | 自动路由到当前健康的低成本聊天模型 |
