...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 10:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GYdS8ZNnFa9cyIgWf24NvJixbgIX81SFKArsaHQsGy4DKjwm` | smart-chat | 🆕 新增 | $9 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
