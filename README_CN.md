...
|-----|------|------|------|---------|---------|------|
| `sk-vKmDrQ4T7ZQendIZnnjX5aqQDGvhB9cu8BR3iVUdzfR5setf` | gpt-5.5 | 🆕 新增 | $25 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $15 | 10 RPM | 2026-05-02 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `04-30 21:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat | 🆕 新增 | $15 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $15 | 10 RPM | 2026-05-02 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `04-30 21:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J429JwNG7MMAUFGVh96BIjtEl93KROBDnROupXUkjUyR7HsT` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $15 | 10 RPM | 2026-05-02 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
