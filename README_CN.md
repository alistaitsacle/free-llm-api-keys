...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-mYcw0vWDpooJcNUHSCqobqomDMnW3jDPf3RXzywwZ8vLlZ7R` | deepseek-chat | 🆕 新增 | $8 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-RfhcL8RcYHGn5uVGKW36kcNZYrPKUPATZfPjbtqNsbppQkDf` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 15:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-j7VDJPBm2eFEohiCBFWAQBztP2Nafo3dAiYqWrOf6JYXAZRt` | smart-chat | 🆕 新增 | $16 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-ylkQrzdUFgvnnDaBABYM56oTfTeGGp3N8L9YARWzUiCMNjTO` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lxGDaMRtncKskYnOUDaLU9Hg2HqeSDUofrig2FJfQnwtkMPU` | smart-chat | 🆕 新增 | $16 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-HBarXBScSvDepNgcKHFasGC14FTrJEWIcwB9rFY7PoFobpk1` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
