...
|-----|------|------|------|---------|---------|------|
| `sk-zActIrWGsWXHXuUQOwHtDViZyy5KQjgLIGvNgFa6CwuAPo9r` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-BmCqbo6KbihCZGfddgwoXrnLnn3w2ssFbLwo9KXAzrIBpft8` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-NE3uvm3afoYluB9id1XtWarLQ5IwjnFcOVtDRuMI8nd7ocnK` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-S3SAnDp4TzSaubgVAJ1SnMAlB8mj3uzVpU3Nvbk4RdaOnqru` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-Eooc9BQJ3u5h7RNxY8r55zvVocDS4NRVhSqihrdhutbURqUm` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-V2qgvHMh4e2RnXvDyPXWFzuDSBfL4Tn8hBDqrh9s2cHdP82L` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-bnUskTzg3KrWhJjR6uXpZDN1aEzfKFlRV666oQzb4Xg1XpGG` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-dATWs74KYaywRbArCNvnIEXwYUQRl6RVh55PjAD8fmbC8hoN` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-jv3u10HrmGqjvIrt3CBsPoNlbcPdtu2KATMp3Fp6cKkqC1lm` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-wChn1VbKwDzc4slVAE8xWVxm34QE23zAr7eM4sVopqXXT2dv` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-wFqtrb1WOFq1CFGpPNEPDFEYfzyKASll9Q9q1DxKRoypt96W` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-pxyoRTVqLRMbpMHOnQma0IVeuQvcg7sQLXs3CjZLtFgRIXK5` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-K6Tb8nCdWYPpy5sDbLGirlSRtaYCsrWwIcWDDDWVKejhjE8m` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-XGutnrP5yGXybpF5GpZ29qdqSXVedCnSHrh0xcfJcvBYOR6i` | deepseek-chat | 🆕 新增 | $12 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $12 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 02:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-w1eJQb7vcfxyJCrC91QXhKgUlKKk0NJcmZM5l5wzYPeCasLz` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GUgKFcS9yCH2E5wnKAEnZe2Dgq9qVhi94yQPCaYHnIcOSPxJ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GRFQWhjn9R7YcEPW41i7ansfH2QN8M92ZRDRekdJKeghJQli` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
