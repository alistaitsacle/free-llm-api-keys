...
|-----|------|------|------|---------|---------|------|
| `sk-gAfxgggsR2RLVxSIMAt5OIi1rcFFrGgpdkLe11FbTtFgdPRN` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-Gdjtupq9wkCBxYevJsmK7rW5Xkz2MJTpgITgsOqk5HRiA0vX` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-vxudHfkRetNbCtQGcdPkp8H3uvUVTEz4Smi6C7d9EYdcHDSz` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-m1vFUHvRhmWucNv9H461OnsarbWkdRNTQHcAZHqyNlm6Dom1` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-bYZHq6dmqPhXScHA9oBkYQfutpDsFPLWgbws0KG2SNgr3lKJ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-krq1gryvp3xHfahjtnb8YkRictw9JAIStR73TblS9jyNsW9G` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-fXS1q3EzSmwbt0ITk7yqSMicPML1qacmUdqETTqDjObpjime` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-dryjXsT6FYaQXiYtaGtXnQrq1nfBca4vz9J6NUQ8iT7wxFlw` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-Vy8dDFOEhdPk7HqUq3VxAY1QB5nzjOQUOJ3hg9s4NYtrfWE6` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-yFyRndUFWz6sD6HzYZeRy4ZAeDdWF7L9ZXvTVdieK37j4aSU` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-XtMz9pELhVrArygqzlRX7RHF9gMYhus6jSmmn5U7UUVMgb5A` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-WBQYFJh2dEbPUNGzFPUx91bMefZxR8s5NiEOjOQYj16mYHm9` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-NjxdpwNKNnBtYQS9dM2d25oigOjlgCCcUxb0dRhFJ0F349Me` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 05:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-ANnVz5XMZ8HaaBtbO0CRfYTQqxkFJIY0fZMPXjG2Z29KHIgb` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-IVsuY0EtClXD9aSoEbQAx0s3Kgy5D3Mkh29IApewJGlggT43` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-1xn07KwDpR6agIxGrlttAeWbMnhufgR9bpMXicp3JRVLoT0b` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-8jfT5iUpUK34jDEtzduz3Y8nI8SJNSzU7Odm1N2nJeryDWFc` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-woV6TNqKl1TcJUlJzk0SHjC6N9O6gfEiVOiMqYcQIHKduAF3` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-KjAfapNQ7Eb0YAl1ZWLF4TGuzc8BvqUKrr0VKHvcUAK4pTTw` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
