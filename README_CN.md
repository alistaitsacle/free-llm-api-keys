...
|-----|------|------|------|---------|---------|------|
| `sk-fl6Ma5OygjJ7tWjQ10uTSU7ODgw7QqQapJsUV1Nq0cDu2elg` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-w2WptbLiKW3hemZnFfyP4S3TOZCMu0J9Nrx5UEABBc06W7hJ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-cc2zYsw8JvoToxuSgtAbnchHoutf9wpdKeUKtbizVj1Zca3G` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-MIOoU3DRSl4umofC6jva0APSi1Z4YW2ktzenq6u5Ob6FUIGJ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-o5GzZEIRex1RCMLJIWw8FfzssfXEpPu3sy2L9jxIC23Dv08b` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-02 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-NqHXFjgTECAMrjQztjkPO6KyxAivnxwDAaZqlYTVTc4isOcg` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-urNiTiqT3DY5dnmUuISZpgetPpk45pSKGVxLgESVq2uDh3ON` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-QOkbZGaUHAr5VALHYf40iGCGW4GQIdJftfxiYZkTy36b3r70` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-Wiu7BLhrmSsgzUXOBrT9paP0dV6aqn7EAh1z6Co8hdl9GfQ9` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | Gemini 快速模型，适合长上下文通用对话 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-1RkX3ihMnBG3DRqrITJtW741jhgB647ZxAexr3IaLuFLpDVD` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-Q6gaOjlrcwmmsttZdLDO3cofKmgk7lregVRpvDDOS08dpf3Z` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-3yGt106XBOPzfcfQ3oqwiELeu5VyaQjoPJmDBR0ACiV9bCeJ` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-NwPxtPgAG3d4uEH3j14QaT7Fv440NSv4DQPhhzZK5CLSH1qm` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `04-30 19:03`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lzyHv6f30cnPxf2vEsBsTud7YkGzuOTI1965bi9KJqeKsoNw` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-rKrbH1S95f4dSBEojRPCqoYDU1bcybPTGfZmIfjVOJxQtjdV` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lSxEPLPnaYaWq3rjm8CmPF6pmHIyXDr6jiNFcvGjiRMrr1YQ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-02 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `04-30 19:03`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-02 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-g9lToFmmj1DaMbgtYriITMU8SI5hBvhvdJMKb64objPkP9rl` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-kTsGyBtE3s0EdhKFR0REKmIopUZHXwMqeaycSoQQxVajaT2z` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-TyLapP0PIEFtFOj8R083hIpqrQ4scv84740aRZnnFaaWwig6` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-CDzWQQWOktAvlTlZZ5Oi8GaYrsawIX4fd9dufON7RWlsJ6gv` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-KWSGbJ5UFIiW7TpvAYXvNzbgK3VQfr2JgBOxZM3EzzAEwZZQ` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-HDsREYfIk2OjR8syKjvzNMO5TDrJffRA1xQnuESYamA5R5ax` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
