...
|-----|------|------|------|---------|---------|------|
| `sk-5DMwTxxcTDXYvuI6odfagdKxkHs2sICklTydSbudY33SmNmw` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-JJhihrL098eN1qHmpTUcSbrzpLT2ofgoZWbpgQtJPYEroq52` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-QqiDMbYhdY4xZysJSwqmCdb1hgqrQlWGjxyaKoZfzNux0wcO` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-wrxo06DCb9eJG2Y1XbYc5o1WNZ8Dtn9jf9cyZzpj9k8w6bGw` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-D3ry2GkxfOMbImtzppF0XeeAYQN0Y8Rx3eYmNAHlkzeEdpCj` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-az8a7Q01OelGreDR0UyoJUCEoLSG0NBGRQzrH97RDkRUHlqt` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-efO9j8VchBeIeoRHYUfzGOMhL9pi5TYcEwklezNDvRdKVmdu` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-krszzAWSMHBoOGaT1klQL2xbzk7JoztHjbvejEmB8XqO47U8` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-21QL6X6yWd8RpsSf93OxIDS9ACxtjuN7NguSPk6aJoWDzFVA` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-e3FE84drEBDWw1XGRMdlGqLzzB6MFkUfGBt0MhHcCYUmda7j` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-9KH8CkI2wdui9JbZRkV3PWTr7tDmfbfUUUBMEQGQ9pY3kEBJ` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-aqoxrIzRzTvK21EweqI8pKB4r4A24qigXlgg0wakRqKIZJJE` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-XGutnrP5yGXybpF5GpZ29qdqSXVedCnSHrh0xcfJcvBYOR6i` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-vW0ro6qlCSi91aUOccztxWv13udbaq1za6lYUznYzaCRgD93` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 20:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-fQcFvttxMS4suO3yX9C6xki2ZFpjqdVIkbs7Q0Udy8YENSJL` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-uCNIVpxHjQgB88i5dWHBFlYzYnM70J0X1RfY3LOXD4jrO5zl` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-5nPthspti8Ak37BDluPCqOr2UlmPKjQtPmpPGmpio3o1ICgv` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-HGELPNUNiMFm4r7LkA3VoArwPIRZoKFwV9exxKE0mgX0GRed` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-XP8GKCJT2O4MjKjpxlYchfNnIX5Nr5hLav9nRIRwVayZD8Dp` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-upL98pSkDuQDcuu5aweEDwFDh0KBveCEK82pAh20iShtfNgY` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
