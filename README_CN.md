...
|-----|------|------|------|---------|---------|------|
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat (gpt-5.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | GPT 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-01 11:22`
