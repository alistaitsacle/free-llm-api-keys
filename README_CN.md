...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-wsxWtoLVB6RsBTEChWAVGCKcdHqXtBS19IS41UDV7AVPuZIx` | deepseek-chat | 🆕 新增 | $11 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-aKuleoTPeQDzs1ZCQCl3goEmi2Lwpy2On5iAUyc4nCgh8M7A` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 05:31`
