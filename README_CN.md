...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-rgD6o8HreBXxr22MoqOXhh7589ty03rSabbaNJDwb7KLNMzk` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-04-30 | 自动路由到当前健康的低成本聊天模型 |
| `sk-jP7af02GAf7HjsXNIg4RLKqU4nltejh2xKaap7YeQqSX08Sh` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-04-30 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-01vYFzP3I3YkiRDd3dxkgUn9Z9vnxcaKoC5r5danm5ioFIm9` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-04-30 | GPT 旗舰模型，适合高质量对话和代码场景 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-fKNXDE972ZTAPmINwemuEFyJoqH7NPahFV7URIjNKUGfgWiH` | claude-sonnet-4-6 | 🆕 新增 | $50 | 5 RPM | 2026-04-30 | Claude Sonnet，适合写作、代码审查和长回答 |
