...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GrbAHGpoCa1RWGs0LcKkzJPMgSUhRyCC6hVrSqKAmKoJQasr` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-XGutnrP5yGXybpF5GpZ29qdqSXVedCnSHrh0xcfJcvBYOR6i` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 23:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-Rm5Mupc6N1QTRgwNW2xDafCpzl510wiiXbKwqO2XHG2L5WCM` | smart-chat | 🆕 新增 | $12 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
