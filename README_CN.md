...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-01 10:52`
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `05-01 10:52`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
