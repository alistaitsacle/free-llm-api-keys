...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-DAUiIB1ANlMFJWDH8Ay8KvlukMdz5T4URhbmZZS0PnLophxf` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-LcI04I5hbzSfumtFVkZjyq2SIt79AtrDmBaAc2h2jnmNa5m8` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
| `sk-EohgSiOGcCALuq1rRHZWRQksFMqf3gQxzGx4XPp0kkS9JJM8` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 15:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-dUkozFwXlozUc5qk706eR1A1ktGkgkMG4v9VCHRr2Z9oGu8x` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
