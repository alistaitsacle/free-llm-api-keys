...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-suxUZb4AaWvsCJmG5rpQkGMVOFhRpfapQkuZmeGaDGkFfj7h` | deepseek-chat | 🆕 新增 | $9 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 15:07`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-rC48SsCX7BCBG7VjXGdh1dwBSASn5inaE0VOdGBzrQomGWKU` | smart-chat | 🆕 新增 | $8 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-8cv8qcVYJuFe7KXBuYxOHcL455XD038hDo3bGmSzkhpYgMbx` | smart-chat | 🆕 新增 | $12 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-oma5jvLCpwApVoVTQcloPlSdAUISEibn9Okdu0U33lJZOBiT` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
