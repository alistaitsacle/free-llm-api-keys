...
|-----|------|------|------|---------|---------|------|
| `sk-DyTHB40dUEsoE4lQvyZFzuKG5iGPtyuIkn7CqhP5ZoCuc4Cp` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-Kp2ikOuTLcpeEUr4JnDSxVBVKB9BwXYxDBvnjbrtA2Em7bNp` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-zruP72zhF1UQJoMvDCyz1yOFaCzZ3r0dMaAD8x4Xifd9gjNT` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-ekZ1f8KmpnY4xzcmOgqoHqxEiYz6CRs8EUftIOsyM2l6zVC2` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-2cBMuF1wGigdKhJtOLiaRSldaof5hpBGb6pUzvSjmCxQG2PL` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-XpQiILCS6MWVq7HDlgDBzD1AwhzLkUAMyLfMFyFtLc8OtpP5` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-aQZDcrCvTVTfMqF1cTO1PkPj1FopkVL6LBSnTSU05ulWtaaO` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-cXj9ijqh95yjH8VioQnKih4MoaAziSZt9CUpkK5SKClkOPJV` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-K9gfEOijIHxYdTuvLfHqMgMfCte5NPpvaO3jrxDo6ovA4RIK` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-lWDoM0q4oe1SfnZ9kI0XsOEjIOEE4wNOsaRoS0TawXD59AdA` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-GF65lkaGu4lwusI9YN9s8XpT46bDvS1xeAmyWLybzUZrPC2e` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-AnGdt8ht3FSnNflmtQdjzNyq5WiR3inhpovt83MPur9iwxgK` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-suxUZb4AaWvsCJmG5rpQkGMVOFhRpfapQkuZmeGaDGkFfj7h` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
| `sk-KtVrJcqwqpeZjvOHq42P0v4Kdtg0F2NYc5SzBflxWS79C5jT` | deepseek-chat | 🆕 新增 | $11 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-B5r2hLqffjKNllTLvuxdNDrj1dX53rM51Sq70oDodOiBE4Jz` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 14:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-gNa4um7y4BfjOmU2uqzcAA1ETd1XN68a00sxCRrrdBPTqGMq` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-rC48SsCX7BCBG7VjXGdh1dwBSASn5inaE0VOdGBzrQomGWKU` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-8cv8qcVYJuFe7KXBuYxOHcL455XD038hDo3bGmSzkhpYgMbx` | smart-chat | 🆕 新增 | $12 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-oma5jvLCpwApVoVTQcloPlSdAUISEibn9Okdu0U33lJZOBiT` | smart-chat | 🆕 新增 | $13 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
