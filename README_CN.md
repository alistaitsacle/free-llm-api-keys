...
|-----|------|------|------|---------|---------|------|
| `sk-r8ZgrB2MeN3CCLH57tudy1wQCmWUjUcfc0WwTSZ0iJxLDxXn` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-ZJBhYBFIMkolpqBcnhPorF3LzglJbFOPXnVC7uXbu9honcEv` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-OFfjuAbUstBY5OXzQ0Z3l7cylNTRjD3OiLWxY9ILijc6gMU1` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-fwqtyg72CusR4EhsvfLIf1zhiBYEttx1E7u9bkA9onrA82E3` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-o3ar26LNbXiwrKuG1cHc5FNvhGnkaoUmbi5gw9SNYSXIi5c3` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-alIB9sHPY9CTPV0to5mGpirVpioBi0RCqJxeUd9Y6kQICNyv` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |

---

### Claude Opus 4.7 `05-02 23:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GbgzaJolBlZXphGg8lxES2pOiVt6mpHWme27XXzsJsJgSLlo` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-fkSDKBos7thErdrcAwVbz6TigrueXsPgaZaAW3aTU1v4ksi8` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-hCTdER22ImLpbIgXuk6iXMobKFDFLtVopxDW4TIvAwG6WplU` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-5Ax9u2RzpLJ4gocfzAbS91ZgOO3LvDPLsbJ9sSdvZyqekmJZ` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-5JsDce2mbYcTRiiZzzEDWepfGprliIHDgq3T1htQPBPGLhjv` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-V6x99Ua5tnSnjr7bvoUPHuW3XvHJlMLHXCs5ahU02LHGGarJ` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-TpuTr7RBRRPG89f01bip2ELTwe9pgZnHDj3ELyEJNeql9xBv` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-CAA4XTFoL9XMFxapSQGEUGuct5oCOj2zCYfP5QUwRMO0srq4` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-Dc69zfKvugQbHHvnasvseLK9QgBZnsDNLhecc8servIuVYch` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-HTKg3KovG2xyQKXLwHBXEUGY2J16CsEyQMrfrscWCwuqVMlJ` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-pDEqZF31PCc2Atzlg9cSj7bND4q2ECoVcMIKM7ASpJ8ZV7nt` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |
| `sk-qdeorGQ5iIb5twQWoyX7K132hbYWPx0Akgkxlv8S2R7IPlQ5` | gemini-2.5-flash | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | Gemini 快速模型，适合长上下文通用对话 |

---

### DeepSeek `05-02 23:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-suxUZb4AaWvsCJmG5rpQkGMVOFhRpfapQkuZmeGaDGkFfj7h` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
| `sk-Ji3YsLnBpiw34rx0YFITYddJtZC09doZdxualm3sb84jbU6w` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
| `sk-KtVrJcqwqpeZjvOHq42P0v4Kdtg0F2NYc5SzBflxWS79C5jT` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-UDC6i6ng6YWhaezj2fuK7vLIma7WvKq7cwFBQMsbBbuvYZIC` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-B5r2hLqffjKNllTLvuxdNDrj1dX53rM51Sq70oDodOiBE4Jz` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-02 23:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-zybk2cbCyLzij7txPiT9k9QtXM4BsrHApaOzr93D5qfC6PFG` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-p0dk1MYQJ4qzSh74PpUyeO7WxpE7wE2sb6mQRGeQTowout6e` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-va08Rr3QP27CV6AXNzoabcR0pUToOP7uu3nj4XINQP3c3ucm` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-W7ZaC0fyuQuCm5f23OE0oiZRXYHpPOM9mKueoWzXK2k855qO` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-sYrbCp83Zxp08pbiZIy0iRGfls3GPQd0vty5ycf1LA4ZOeRg` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-yuyi65ADxU7ZuF5PQ3fGIqU2PsEqvX5rHTWSNY73LRAeKIQ7` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-zhN9vUESllNGT0VlbRdEsEPwmvCO4ocIeKMS4xl6XJdQ7Apf` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |
| `sk-Baojw2afgETTUVwrTKmTCz1jAvYdPjEikEuS0JSM8UtjlfJd` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |
| `sk-y8gaqyr69Wt6B9wLRaXMHEMaUI4gtlN6jwtnVeGhEQW8izjw` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |
| `sk-B1DTCTNMwkw9EpoXH2iJXVKSBYz7osa11HVxIecH9J6DKS2R` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |
| `sk-gU1sEm4HlOpkNWfWqXITBSZahnauzDr2pNJGumxMHbeBbNyR` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |
| `sk-0n7KCVlhAO0wC16lAf3fIJlaN58dbIYic17WZC7OB7KJFrgR` | kimi-k2.5 | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 |

---

### 图像 / 语音 / 向量化 `05-02 23:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-gwWyEJ2LDQwG7iGj6omssp6QRupUI4LHXCdHjGlyvFzZnEKn` | text-embedding-3-small | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | 文本向量化 |
| `sk-bzDiFLjbuZNLvDATOUcNVES20zyau5tMVXvDksp8FOTkO0vq` | text-embedding-3-small | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | 文本向量化 |
| `sk-KP9XQZPvZN00IyHCr57Zrv5U364dcW3vtdRtOnCGKfpR4s4r` | text-embedding-3-small | 🆕 新增 | $20 | 20 RPM | 2026-05-04 | 文本向量化 |
