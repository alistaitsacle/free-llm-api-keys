...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-5HdDpDhhiEw7uyobkLNmyvGOvf4QFaP6JqjdMx7RFigoOXgi` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-rhnbSK9nVb9QW0CMARLTM2lrxQH3ZspysFbSMclrLTnopCAa` | deepseek-chat | 🆕 新增 | $11 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-plMBUkF55ZDNc2wbG0FeiWIcy9sUH2MHO43kSbfNX4egqOCf` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 22:52`
