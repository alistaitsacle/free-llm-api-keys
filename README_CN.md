...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GrbAHGpoCa1RWGs0LcKkzJPMgSUhRyCC6hVrSqKAmKoJQasr` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 20:52`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-Rx16hfqpZGASlbVsQKWuTMu9iBvOMLEQshceHP2GQDD4asYy` | smart-chat | 🆕 新增 | $15 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GKKKI3Dd9jtkbPS7ljAAhDQOcNNuUmGVsEE0yrVef65yZPmC` | smart-chat | 🆕 新增 | $14 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-kLlWVyvuK4ArNvH34umGvggBvYGgP6M5Sqvn6Du7CV2WCJNP` | smart-chat | 🆕 新增 | $12 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-h9YonAJwjrFLVopVEEXmnRW2Qyry3EYVX4GhKkDh0hzVOoMk` | smart-chat | 🆕 新增 | $9 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
