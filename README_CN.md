...
|-----|------|------|------|---------|---------|------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (gpt-5.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-04 | GPT 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### Claude Opus 4.7 `05-02 10:52`
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-02 10:52`
