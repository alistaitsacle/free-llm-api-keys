...
|-----|------|------|------|---------|---------|------|
| `sk-Tvez91817LhBkr4aoYlI2VwObW39pgKk7zRESn4aWc4SOMDw` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-wInDs2eD0dPbr6RWlbqNM2rJf4NRh4UKtamhUd9A0qQ4AOud` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-RUXIvN6CRVls06HhRonv4AURhiLMTbvgpE3PdLYOSJY12CtI` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-VANELRhXRpPfof8PyDNGEAQKJWMSA0epL8XezP2xyckrE1zO` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-ECS2iWeW1vGJuQMRcsKwwGuZsdJG0skKWeufdweYuzyvHJEP` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-J6fLosJnqtP2P8YpAzMyVcZtd4idXc752HLBjZ3Uonpy2Tze` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-Ow8gLsBIGLjcm3qbjvUh643RpePMsIdUccOVOTomJXFaLdB1` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-UoCK1UUCTRznjdl77vFdP9i7Jbt8kKIt5dw21tX5A5lVDpAU` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-RTPSgtFpM5hvCxsnwmImeDzQ0QQ40G3RuV6EDY4MKBJxY2lz` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-a442H8ZHOBqXglHLtMoaXAXvSZwk45HqETplZU1BUKWSu1xK` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-95rVVSxvQQTkTVY4x4VNznApzSGOOgcw2TZFN9YYYvrGw8N3` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-ncayD16FFqkKQzDWaOL3dK5jQ78u8PXB8QcgKHVauzR6eFDe` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-suxUZb4AaWvsCJmG5rpQkGMVOFhRpfapQkuZmeGaDGkFfj7h` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-04 | 日常对话、代码生成、翻译写作 |
| `sk-KtVrJcqwqpeZjvOHq42P0v4Kdtg0F2NYc5SzBflxWS79C5jT` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 02:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-cdddaM1CjwWof4itytMgW8S3na0UwKylAoym3ad4glxZbopZ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-0NUjfabVa3XiIZvQ03dl9ToJb7wmqkvPnjJAPuGgMPFp8D7v` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-fnOQ5M2YZig3pgUHHBD0ZMk3eKa86IEw32smYFYXS5odozss` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-5kIeEPqSKnYmELscgkQCu59n3grt0b6rXwpyqun6shbNOBZR` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-qnwtVbMz35rME0QyZv3jGLsabBibGASU9cOZdkxF33yTFfiZ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-wxCjQ102YcbNr2nWlUqFBT6vyEnYPuZeqlWP32lhqbgPAthp` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
