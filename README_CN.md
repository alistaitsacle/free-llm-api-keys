...
|-----|------|------|------|---------|---------|------|
| `sk-bYZHq6dmqPhXScHA9oBkYQfutpDsFPLWgbws0KG2SNgr3lKJ` | gpt-5.5 | 🆕 新增 | $9 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-m1vFUHvRhmWucNv9H461OnsarbWkdRNTQHcAZHqyNlm6Dom1` | gpt-5.5 | 🆕 新增 | $4 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-vxudHfkRetNbCtQGcdPkp8H3uvUVTEz4Smi6C7d9EYdcHDSz` | gpt-5.5 | 🆕 新增 | $14 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-gAfxgggsR2RLVxSIMAt5OIi1rcFFrGgpdkLe11FbTtFgdPRN` | gpt-5.5 | 🆕 新增 | $0 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-D53d63szNVkNUxPJhJfzJTuiovKul8QNDxPvesGZcd7DbsKv` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-fAYrLEvuGqOctzKUQoZqksZtfoIL8ej41cjQR2S1ySFRdx4s` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-WwpE1DZGguRqBwT1oD33iCPGhjLDrtO7WtCsxlDlhoSmDgVb` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-DIB2Bxenc5Ufz2GDfBgCFYe5k0j814Btuh7s7nEXZo6eTVMy` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-BF98JlOU3ToBGLRprKWXSulITPgqeOMKbQRvpqUf8WyiPMe4` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-FyzCBoIAENfGSFIxMABIyuYISkcwEjCMRqWC8oqXkUODIapW` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-WBQYFJh2dEbPUNGzFPUx91bMefZxR8s5NiEOjOQYj16mYHm9` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-NjxdpwNKNnBtYQS9dM2d25oigOjlgCCcUxb0dRhFJ0F349Me` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 08:37`
