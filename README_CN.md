...
### 多模型聚合（GPT-5.4 / Claude / DeepSeek / Gemini 自动轮询） `04-29 12:01`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-kkNPf3gVEECJGNFsPw43JZB72KYJZVCPawbcZ1AJeWhZ2cVf` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-05-01 | 自动路由到当前健康的低成本聊天模型 |
| `sk-iHHGWK28kUJOtwOoRt2JABAg2EFMpAi08jPMeIQwAbgPbmYq` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-05-01 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OM2owIPZtr7wswM1CMeNSEr1i9EUXIA549hmQf4qL9oEHTEF` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | GPT 旗舰模型，适合高质量对话和代码场景 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-5RqEYfhkciFDP1Bvk2i7AnMsPDLVfWnYCg3L2UHTycEiuHxG` | claude-sonnet-4-6 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | Claude Sonnet，适合写作、代码审查和长回答 |
