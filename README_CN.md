...
|-----|------|------|------|---------|---------|------|
| `sk-Hb5vTshNdNJSBx0kRx96zSM4k2uFfWffJWThuWwtA5pyxeRS` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-b3eMyrfmW4rtmt1oJ6PplxlEojykHSZu3SOZyNrRjfrOyaxO` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-MIOoU3DRSl4umofC6jva0APSi1Z4YW2ktzenq6u5Ob6FUIGJ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-cc2zYsw8JvoToxuSgtAbnchHoutf9wpdKeUKtbizVj1Zca3G` | gpt-5.5 | 🆕 新增 | $8 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-w2WptbLiKW3hemZnFfyP4S3TOZCMu0J9Nrx5UEABBc06W7hJ` | gpt-5.5 | 🆕 新增 | $19 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
| `sk-fl6Ma5OygjJ7tWjQ10uTSU7ODgw7QqQapJsUV1Nq0cDu2elg` | gpt-5.5 | 🆕 新增 | $19 | 5 RPM | 2026-05-02 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-YKipJZAxLHwfNO1HfBzaNSXMjo8sLKuZtqwxWNHTecw5bEBg` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-W8snONaUv7nMy7fUF5VG5FwfzGLP6Mm2Goq4CIRZEdMPhYBw` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-1HBtjOToWc30VjmSlRuPm4PllyG3zE0aeoz4x2hqw2cWoBEM` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-FXVDzn1AhJs1WNYYq1sEh4p6ThLUWNL9um3nFr1cP5Ljpigg` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-BP1c1XALeLLsjzOkSQITt24q0AH6ZgkiTr0LbP9Hsa07b09P` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
| `sk-pBQPAv622bnJycWUxBhUixiSKF4LmTsM9wAlbLAFTN2OyzgR` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-02 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-NwPxtPgAG3d4uEH3j14QaT7Fv440NSv4DQPhhzZK5CLSH1qm` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-3yGt106XBOPzfcfQ3oqwiELeu5VyaQjoPJmDBR0ACiV9bCeJ` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-Q6gaOjlrcwmmsttZdLDO3cofKmgk7lregVRpvDDOS08dpf3Z` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-1RkX3ihMnBG3DRqrITJtW741jhgB647ZxAexr3IaLuFLpDVD` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `04-30 21:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-XO1mGkBNtcCu6Jt5hEds4XOl9JBwswRqCpI1OI70xYR4N63v` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-phx0dMKjPuXmh12TMNsyjaUgH1D90uJwUIFxYDJcdGAR5Z2v` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lSxEPLPnaYaWq3rjm8CmPF6pmHIyXDr6jiNFcvGjiRMrr1YQ` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-rKrbH1S95f4dSBEojRPCqoYDU1bcybPTGfZmIfjVOJxQtjdV` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-lzyHv6f30cnPxf2vEsBsTud7YkGzuOTI1965bi9KJqeKsoNw` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
| `sk-OEKjGQ3zKwI3ATUOFs9xWrxwtmqe9KhmaUSANGPvmnzImFst` | smart-chat | 🆕 新增 | $17 | 10 RPM | 2026-05-02 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-XO1mGkBNtcCu6Jt5hEds4XOl9JBwswRqCpI1OI70xYR4N63v` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-02 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `04-30 21:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-XO1mGkBNtcCu6Jt5hEds4XOl9JBwswRqCpI1OI70xYR4N63v` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-02 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
