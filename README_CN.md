...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-rdH8KFC4b7WOW9I93qOhR9drRUrGfUdwllt594d5jqoWxcvP` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-02 17:27`
