...
|-----|------|------|------|---------|---------|------|
| `sk-QlqvAxJnkeFOKAxqb20WCBXdTdGBti4v9uyUCn79Jb0OoZYi` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
| `sk-Vr0c8ouLUbfteCB3frbcYH9H2zPJc3iVoFYoOiJuRXVHxJ0s` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
| `sk-hIjk95HsqBK4vZR1gOwC9NecVEEhp9t8HtHgHf14gShP3JsZ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
| `sk-Fmwk4R8uE03QIx9NB15Ggt4VuZA0tEdGJyr9GF4jzdrgss7w` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
| `sk-DrOe7PJyNvZuXceISA6jlutfMPAayilOruKLEaCNkToI4bE4` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
| `sk-p83xQAfukYZwBjbk3LtkP9ceqQguusVHtNhBXsevGZKoZSy1` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-03 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-MPOWG9MksKO4yJEFIN8nYUpvXgQpDbpK7DFq6ldGggNGXTYK` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-6tG7WvLHFsLknXbw508rBqE03e38DS17bGBEoaP7O8BZlrFr` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-mpVTPyPqfbTJUniIrWhXF7qvSwSBqmQrCAQKqWBo4gmkVKvc` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-oAoc48XwNt2XpaixEDmjgBNFnUWXdnIBkzM4s6waeO5wGwO2` | deepseek-chat | 🆕 新增 | $11 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-01 09:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-MPOWG9MksKO4yJEFIN8nYUpvXgQpDbpK7DFq6ldGggNGXTYK` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
| `sk-35mV2xARxravSL7Dmd0w5EFZ9vEfGba3WkK30Wg0c8gW3hII` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
| `sk-CjhbXAHfl6woRKJbe7Dmj6cmK56iSyf8HH9uarYqrYyi0pfQ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
| `sk-0MWw4TSdAZ3DFL9Wc58SLtK5E677ZXNfPCFuI4JSHc0ihpbM` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
| `sk-RJ47kY2uZg726VHyu2Q9GFH6bVmjKzlu4okz4inVG1STnvU4` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
| `sk-Rdoidjo2AQaBJHpspi44jX7kOfwOGw7SGRi4xuskbaga24zD` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-03 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-MPOWG9MksKO4yJEFIN8nYUpvXgQpDbpK7DFq6ldGggNGXTYK` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `05-01 09:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-MPOWG9MksKO4yJEFIN8nYUpvXgQpDbpK7DFq6ldGggNGXTYK` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-03 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
