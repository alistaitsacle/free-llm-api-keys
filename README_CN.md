...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-06 00:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-Je6fuau0eqrzJGmfzZhBdnJslGfL21M8vzTdBzz2JD6TXapT` | smart-chat | 🆕 新增 | $13 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-esSp0A2BlqjqiBRNOs16tMPi6IuH8Te84havcqCmO4ouJivR` | smart-chat | 🆕 新增 | $13 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
