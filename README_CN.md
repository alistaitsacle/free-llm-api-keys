...
|-----|------|------|------|---------|---------|------|
| `sk-3huJUdYMoW3dE1AtPKzwXmtHk97Zew4xJwO848aZkCaOEf6f` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-P8la3imrDCVIPdHmBcfVyMWlAnRIDsFdFD4NPOHkPqmiNF8y` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-fYznHPdqhNBfxu89s0p1dw18Nwvo3BqTvoAVM7gw7fvAOl7M` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-vMiGkmfewhJFUJsOgYE06jOaay9Ub9IStWEk5EIz2GyyJPzq` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-H7Cs7PLDIcUcfWtdJweOwAkyUXXBLX8Sgypy3j0pQqtfZ95E` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-8jNeOaKgAf64O0tMgaMUJTMZG7DKa9zWy507LQruGohPEItn` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-ZCaP1WL2AO74eR4oAPYVUj9wthACzeGJ7xuz0k3sMm1P8pFp` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-9uiZJEWSlHhd8YFxVnLzs2tS1M6YCnMsIZrDTbuHvaKLHVys` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-QlhyLQZPgjfBxJZTZ1e7qi1jO7JNIo24CEafT3buawxBNrx1` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-Lnigvl1Us1rL2ZlwLjUAT9NY5S5iVgqmrVYK8ufYC6kOD9wE` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-0sUCcMyQBy4kQAheRWdznnp57Ns8YmgrMv4XvTDfN2c6r8Gb` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-EWZ0c0q0LFZ8KHRAEPlMP7iAV29HQQmnx4Muy69ZHvoKuWC8` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GrbAHGpoCa1RWGs0LcKkzJPMgSUhRyCC6hVrSqKAmKoJQasr` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
...
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 20:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-Rx16hfqpZGASlbVsQKWuTMu9iBvOMLEQshceHP2GQDD4asYy` | smart-chat | 🆕 新增 | $16 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GKKKI3Dd9jtkbPS7ljAAhDQOcNNuUmGVsEE0yrVef65yZPmC` | smart-chat | 🆕 新增 | $15 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-kLlWVyvuK4ArNvH34umGvggBvYGgP6M5Sqvn6Du7CV2WCJNP` | smart-chat | 🆕 新增 | $12 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-h9YonAJwjrFLVopVEEXmnRW2Qyry3EYVX4GhKkDh0hzVOoMk` | smart-chat | 🆕 新增 | $11 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
