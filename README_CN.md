...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-plMBUkF55ZDNc2wbG0FeiWIcy9sUH2MHO43kSbfNX4egqOCf` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-XZmYolo5xsbJQLpE4ms8VyWDqL46KCMO5ZJqFMaLJxTtvps5` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $12 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 16:52`
