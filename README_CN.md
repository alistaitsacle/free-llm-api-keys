...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 04:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GRFQWhjn9R7YcEPW41i7ansfH2QN8M92ZRDRekdJKeghJQli` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GUgKFcS9yCH2E5wnKAEnZe2Dgq9qVhi94yQPCaYHnIcOSPxJ` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
