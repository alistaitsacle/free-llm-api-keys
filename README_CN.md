...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-wsxWtoLVB6RsBTEChWAVGCKcdHqXtBS19IS41UDV7AVPuZIx` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-aKuleoTPeQDzs1ZCQCl3goEmi2Lwpy2On5iAUyc4nCgh8M7A` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 02:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-XJhC8Xtjyn9CwrQtHUAiqSsCjujzImICzXFIQnXZtPezhrhB` | smart-chat | 🆕 新增 | $9 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-LSZvr7uo8dv2xOOkF51m9gVbAlaT2myPtP7p1YM1q0EY0tey` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-67uQEBrBMmbXkY52o197JO6yjWWH0O5iJ6rLok4nQXW4iSib` | smart-chat | 🆕 新增 | $11 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
