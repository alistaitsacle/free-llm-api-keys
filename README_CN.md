...
### 多模型聚合（GPT-5.4 / Claude / DeepSeek / Gemini 自动轮询） `04-29 21:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-y4vTwsx4dH91r7u3CkAgubaz4zKaddiECZvsXfSJwEioDHW8` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-05-01 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-aPJ9Sg1plijhSm8KoFaLQ3pHwOtty4OLFKv7Xhn6xD4tQz1r` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | GPT 旗舰模型，适合高质量对话和代码场景 |

---


### Claude Sonnet `04-29 21:30`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-RKupmURqlu2ay1LdDGRyfNWIriY5f8Y2p5lsdXWWVCTS3Kmf` | claude-sonnet-4-6 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | Claude Sonnet，适合写作、代码审查和长回答 |
