...
|-----|------|------|------|---------|---------|------|
| `sk-IhOG3mwjOlMN2dGfapqnVVA3lpPRCKHNTbvHgOPNxP7PV75S` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-FneuJsluTYNEzIHnxQZwHDFe93QhuvhyjlkHCrxLL4j2CZCq` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-Cz5JJJQ84Ip8epiw5iFHky0OPzaI2EBOomFAfJhWPHEm5aRB` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-9I0URZEhrtY4tyivwIPjTWufQnJVr30DklcpRAD7pbKD9NgR` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-IMCainAYWSWiCAVbLGB1vVlznIYp6txxn3yqQavoB050L9Cl` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-QJMhVKXB3LFiQZymr7MDF1mp6zd3WLFgD7nppVu6fJY2ArpT` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-tfaRNIb475iCu16pGFrrn5KGS7lli7FQqnrYuzcFSFAEEHK5` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-U5lckSSbFBze8pPf3FvsRsJCKTijjNdyYWZMibpbESMn9jiP` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-QmqukXwVQEzzw2Y58F42ZqbCwYbN4aMdUvtHU56l9zb9lqV9` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-DWkO15rrGqtP1BwECA4yB5enqRQuKa0zkv2y9x7IgX9MNqNk` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-GwW7i9F81UB9vev33vsrIWmbkebEf4ZodyplgdZjldtZ61Q4` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-vW0ro6qlCSi91aUOccztxWv13udbaq1za6lYUznYzaCRgD93` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 11:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-mJDf4EUF7KcNrHVBn1rxMCom0g40FSQpFJMNVaHgvGkIyhcG` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-WOjAfdzNyfk6IJHxN8M2zHAw4zAxb3cO0xbVwxGOSW9eiHVa` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-C0U5bQRdMbZJNyP8T28QqGtWGdoRrWwSlxVM2yPXFTM048EA` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-msm9Rp4psze0t9PSUSRCfayPOvIPNU85oeSj9lNm1X6AMVPr` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-8siEZJLxlWImY6penPPn9tGSWeAuMornG767pxw2OL9VfhH5` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
