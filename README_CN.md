...
### GPT-5.4 / GPT-5.4-mini `04-24 04:00`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 |
|-----|------|------|------|---------|---------|
| `sk-TKxqNbgEMTYpIP3B8NMXiKM5nqXKLIIds1qwWL2HDZCWzW66` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-04-26 |
| `sk-F1O3EvZNeg4xVKZYQaYIHEfvPBCc5U2lSmq45SFCW2C67LCf` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-04-26 |
| `sk-WjLM6C4xdzk75dQsiWj9GxtOJ267I4WikjF1izFp082GmxqG` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-04-26 |
...
### 多模型聚合（GPT-5.4 / Claude / DeepSeek / Gemini 自动轮询） `04-24 04:00`
...
| `sk-qSDnFs3zQlpYC1MnLGrjsIbHygLf5xAGFQawNz8aySLan0C1` | smart-chat | ⚠️ 额度低 | $30 | 10 RPM | 2026-04-26 | 多模型自动轮询，不挑模型时用 |
| `sk-yfeBX5ueMkcZFXVuYIm42hMMExY6IMIqqGDdi3g9uJu7JN11` | smart-chat | 🆕 新增 | $30 | 10 RPM | 2026-04-26 | 多模型自动轮询，不挑模型时用 |
