...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-4kyww7OUC6c925oXgryTZOiatgsMghZvwkSg9KuNBu6JBfFk` | smart-chat | 🆕 新增 | $50 | 10 RPM | 2026-05-01 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-J46kSIsveaMKir4kf44KkQO44onBxh6fEUPnsUZ1llvwlW8x` | gpt-5.4 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | GPT 旗舰模型，适合高质量对话和代码场景 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-dUzfhaQ1X3vRUxi9TegUx0iVOFRE4aGadCyHvevSlLi7lIZT` | claude-sonnet-4-6 | 🆕 新增 | $50 | 5 RPM | 2026-05-01 | Claude Sonnet，适合写作、代码审查和长回答 |
