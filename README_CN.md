...
|-----|------|------|------|---------|---------|------|
| `sk-p4pLL6ARu0CJYmn2boLbMzyuchUbWlZ7JeM0cvMJmP2qcquJ` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-IsnAet8jLLwBkRsUjXVd4L4VRqM9e3FG8IqW9H36E1Td4Sn7` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-RfLqNiZcuEozARpAmnzD3ptoStLqyZqRohiy0glY33HCXPzR` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-fLFu8YvTdHsGnC6b36HcmZHkK2pa5qYl78zct35Ag9rHTmdl` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-czAk3ds2wHFo9a95JXFFenVsAUeVEokoelMnw4cL4nvpgIjS` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |
| `sk-82Ykmvh7YuURNLGAJWVYE6d4QhMBPSocQAtwR6mnH1WXR2VT` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | GPT 旗舰模型 |

---

### Claude Opus 4.7 `05-02 09:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-4XO1AeQrYppNYt52pQaHSNAwWwUCAAQNss6nygsOfQyhRypy` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-ntBy3SBHubrzM1ZO1mw1NVXl2mjDsbD9uyXEmXcpiJSSI1Oy` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-OSv1N5M0cRix54MqPBLgG6JMUQqkblVAiLC3oM757PetSZJh` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-qdJMbEh9B1VPeWW3N4828Z0J4EuhlyDmmcydfyCr5JAgqSY1` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-DCq73XjZVvV5ApciJPL3w2oa9vcmVoHuuLSP7SZ0JJvoMLDn` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
| `sk-L9dz3AqcqGh5KfGGlOEe5sbI1CwMrHs93G4IKXKhBKsoA7DS` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-04 | Claude Opus 旗舰模型 |
...
### DeepSeek `05-02 09:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-KtVrJcqwqpeZjvOHq42P0v4Kdtg0F2NYc5SzBflxWS79C5jT` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-UDC6i6ng6YWhaezj2fuK7vLIma7WvKq7cwFBQMsbBbuvYZIC` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-B5r2hLqffjKNllTLvuxdNDrj1dX53rM51Sq70oDodOiBE4Jz` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-03 | 日常对话、代码生成、翻译写作 |
| `sk-Q6gaOjlrcwmmsttZdLDO3cofKmgk7lregVRpvDDOS08dpf3Z` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-1RkX3ihMnBG3DRqrITJtW741jhgB647ZxAexr3IaLuFLpDVD` | deepseek-chat | 🆕 新增 | $12 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-02 09:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-k1OTZ6MgDFp5st7IOX1qfShqCHBAh7aWkq5z34HH9ZSPc1Tw` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-pwbTGOYI3ZpSxaM17xDaUOUGhC6X7ApKyvzL9wwN1dGI6rA3` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-eTyGshFkItCzkOwePbke5n74T7TnTfGqWKDN6FundbfP89ga` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-ggxcxhWVMBStiygsRkKZH07tlNI3MDirfsAquProcOTkfUCK` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
| `sk-ScPpacGvU7H8CWTVlpjwaGBNLNfvka8e3YL2ea40NVUpNOZ7` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-04 | 自动路由到当前健康的低成本聊天模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (kimi-k2.5 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-04 | Kimi 长上下文通用模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->

---

### 图像 / 语音 / 向量化 `05-02 09:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (dall-e-3 / tts / embeddings 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-04 | 图像、语音和向量模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
