...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-NwPxtPgAG3d4uEH3j14QaT7Fv440NSv4DQPhhzZK5CLSH1qm` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-Q6gaOjlrcwmmsttZdLDO3cofKmgk7lregVRpvDDOS08dpf3Z` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |
| `sk-1RkX3ihMnBG3DRqrITJtW741jhgB647ZxAexr3IaLuFLpDVD` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-02 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-01 09:37`
