...
### Claude Opus 4.7 `05-02 10:07`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-V5Tdge0YJbg6SFCBSqi9jYEqCQ2W5hM8PyUmFMbDS10497B6` | smart-chat (claude-opus-4-7 兜底) | 🛟 兜底 | $20 | 10 RPM | 2026-05-04 | Claude Opus 旗舰模型 — 补货期间由 smart-chat 自动路由 | <!-- fallback -->
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-02 10:07`
