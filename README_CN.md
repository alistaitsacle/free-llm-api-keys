...
|-----|------|------|------|---------|---------|------|
| `sk-t3iKV2BNUrN3wLq6sAknAtgOfePLTuaXWRywdPgZxhQM0AST` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-2BNg2yvcr7hOz2qVB3uBTAjsWeQElcFNSEfEVsMUpDy4d2So` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-ECbmRWzsvUY6EPr10Hy5Ac1CUx2kgUimuYCaOptFZl6cwlbp` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-hsZbk0I0mwgiJjBfu5Zg1O7aWLnOzu3UDx4Eszf9NMCGDe7h` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-kIB8A5tzxb5LARhfcUyhGi6pq9zpjjqXSqiK9OMpwl0y7FlB` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
| `sk-KxE921KJduToZrRwjQrR1tLmo0tO5sbW0SqQ46QwG2Lt0IaR` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-ImSySCZL2TuQ5CkEgDfBnXPPjYQgCWLfhK4Uazs6cBVkdSQO` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-rPVE8Hww7r1jefr44aouBigq1zzPDN0hsXcpPr0Z4bykAX0G` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-prN9ShK4UTKwdzphncE2zJwdzaTvVVRKEhJ1QCN1ipwITBj5` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-m2G9bBxbBNdK74pfveF7bUnOmckM2aPk5HOXdHagB1e3aSkz` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-mqBpGhlq1XpMcHy9qV1RovV4bGPb7NXEjGVB6ePuQFDmRbN1` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
| `sk-93LP1Ox8XfxXFEocUqZPOH7eDUn4mviLAY6CcgHEZx8FnEQe` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-06 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-wsxWtoLVB6RsBTEChWAVGCKcdHqXtBS19IS41UDV7AVPuZIx` | deepseek-chat | 🆕 新增 | $20 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-aKuleoTPeQDzs1ZCQCl3goEmi2Lwpy2On5iAUyc4nCgh8M7A` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 23:31`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-67uQEBrBMmbXkY52o197JO6yjWWH0O5iJ6rLok4nQXW4iSib` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-JOzgigsgH6aYMXJpqgGIwpYbra9y4dOKWQ6D4DwP3NMZBrlc` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-LSZvr7uo8dv2xOOkF51m9gVbAlaT2myPtP7p1YM1q0EY0tey` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-XJhC8Xtjyn9CwrQtHUAiqSsCjujzImICzXFIQnXZtPezhrhB` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-6C6q5VGjjM5D2Kid8JfGJgYY7VGJ15ulqUqhYG0SzAWdUVVC` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
