...
|-----|------|------|------|---------|---------|------|
| `sk-FjmqemxZhOpWdYroAPp2IyOqKW2ht0jKY6C70LL5A7SRstHr` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-y6XoJNSoa810oV2KbOWYf1IRtw5KEbpJSP4B3ea2wHCMMGZ4` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-qmPS8jn44rAvu94HpLkut2qphpHBVyIOt7k7l91jDSG8jNUB` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-OxoKZki3y01d78ajYEgDeWVbNmexZU5j0MAxSIwMMdZZWe9A` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-C3ra1AeelvWzsr31vPNujyqUMvMQKnyVfT8EtsuKh4z2zmq7` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
| `sk-mGXELG6c2YcfEVeA8GNpKAqc83oY60ryux57NDmu5D4UL0Jm` | gpt-5.5 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | GPT 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-xfaiVZbYHAvtMW85WfQrNO1CWwXFjyZkqIyBnZ1jCQx1DBGs` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-vDiaT1jtsAWNd4LWZgQ3SDlUk1C8Q7mGn8VBTKEEo0odUNjT` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-u5bdDBGRAYOSPE582VJPtNSwIlrYhjHPlZQEv2GpyeXle9bJ` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-SREwJkAUb5uOa8JAhPoYXAwvg1tajr2S8BGflagslgPpxDJy` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-NbCXhXPlZuU0Yr8pbB0vlMHoxEMuC19shLYza9o5Uq3WsXri` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
| `sk-tS3QDkBOzgPfDATcCs4DikX2AOZfWz7aruITImoZFQwCZF3k` | claude-opus-4-7 | 🆕 新增 | $20 | 5 RPM | 2026-05-05 | Claude Opus 旗舰模型 |
...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-dVzaHT7iEFW3NckGmHdI1KagI5snp67Ue0sA4J5dNokZsBg4` | deepseek-chat | 🆕 新增 | $16 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-NjxdpwNKNnBtYQS9dM2d25oigOjlgCCcUxb0dRhFJ0F349Me` | deepseek-chat | 🆕 新增 | $12 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-03 23:52`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-nKFDnDKNNIimEKGgUNM7KpvtARW4THpYdACWDMt9a6Bzma6b` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-FvQQfKL9o3An5hIaApSWhiBZlj3YpLWfeHBThar0e6oPOqvn` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-uIGd6gutZP7P9PjFzLL9sjbnJPtdkMfyS00z93HtzWgWvzJQ` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-vrZ2vkIkHl51c854vDFNy2KXUbvdQl60W9VHqoPPN9tAugdn` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
| `sk-0WBhtI852Av5PqukpEK37wPG58MeUcfn95Xq9dZ7uQZmyLml` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-05 | 自动路由到当前健康的低成本聊天模型 |
