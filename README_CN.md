...
| `sk-jY7PYxproBNpMyw0FSVoFTjYpfmuCggIj6Sr5ZyzJlO9zpZy` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-K6Tb8nCdWYPpy5sDbLGirlSRtaYCsrWwIcWDDDWVKejhjE8m` | deepseek-chat | 🆕 新增 | $17 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
...
### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 10:07`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-eZYFIDrrp36iutPhZhrsCSQPJiPWAEMw4idjmKI2SdN7Hw4h` | smart-chat | 🆕 新增 | $2 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-GYdS8ZNnFa9cyIgWf24NvJixbgIX81SFKArsaHQsGy4DKjwm` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-6pL4WgRoNYilplBgFbn2NpCIwXGwySZmghFPSIBoHxSd42b8` | smart-chat | 🆕 新增 | $9 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
