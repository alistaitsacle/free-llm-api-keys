...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-OZBReJLHhsUidTzN3Xcu9jcwrP3ly54dOGdn5PtYHclY9CGK` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-aKuleoTPeQDzs1ZCQCl3goEmi2Lwpy2On5iAUyc4nCgh8M7A` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-04 20:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-gXxxRmcnNfS1tTCnD2WFkAnO3VGGrtFY8Iv441VCrH40IJke` | smart-chat | 🆕 新增 | $18 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-Rm5Mupc6N1QTRgwNW2xDafCpzl510wiiXbKwqO2XHG2L5WCM` | smart-chat | 🆕 新增 | $18 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
