...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-GrbAHGpoCa1RWGs0LcKkzJPMgSUhRyCC6hVrSqKAmKoJQasr` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-06 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-XGutnrP5yGXybpF5GpZ29qdqSXVedCnSHrh0xcfJcvBYOR6i` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $14 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 00:37`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-6C6q5VGjjM5D2Kid8JfGJgYY7VGJ15ulqUqhYG0SzAWdUVVC` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-XJhC8Xtjyn9CwrQtHUAiqSsCjujzImICzXFIQnXZtPezhrhB` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-LSZvr7uo8dv2xOOkF51m9gVbAlaT2myPtP7p1YM1q0EY0tey` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-JOzgigsgH6aYMXJpqgGIwpYbra9y4dOKWQ6D4DwP3NMZBrlc` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
| `sk-67uQEBrBMmbXkY52o197JO6yjWWH0O5iJ6rLok4nQXW4iSib` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-06 | 自动路由到当前健康的低成本聊天模型 |
