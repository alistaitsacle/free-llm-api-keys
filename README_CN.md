...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-uVTMb6J6bds72w0ZJdjfHF59EhKTH2Qy5sHmy26ZsymFBIvE` | deepseek-chat | 🆕 新增 | $11 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-jY7PYxproBNpMyw0FSVoFTjYpfmuCggIj6Sr5ZyzJlO9zpZy` | deepseek-chat | 🆕 新增 | $15 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-WHLaG9BKWuNn0AqXYyZ9Cc4DeODsMTsNt7uRvQG55vG5Dnmv` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |
| `sk-7a2ZwYQdSvX2MSLXQGWt5gWEUES58YCUQQf5hgS4TWhENj5U` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-05 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 13:07`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-j7VDJPBm2eFEohiCBFWAQBztP2Nafo3dAiYqWrOf6JYXAZRt` | smart-chat | 🆕 新增 | $19 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
