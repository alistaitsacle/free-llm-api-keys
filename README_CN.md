...
| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-mYcw0vWDpooJcNUHSCqobqomDMnW3jDPf3RXzywwZ8vLlZ7R` | deepseek-chat | 🆕 新增 | $18 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-RfhcL8RcYHGn5uVGKW36kcNZYrPKUPATZfPjbtqNsbppQkDf` | deepseek-chat | 🆕 新增 | $19 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-05 13:22`
